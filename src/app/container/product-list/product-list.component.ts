...
export class ProductListComponent {
  ...
  products = [
    ...
    },
    {
      ...
      items_left: 4,
      imageURL:
        'https://th.bing.com/th/id/OIP.U0jepfI2xnjVrBZIfQ-DaQHaFe?w=250&h=184&c=7&r=0&o=5&dpr=1.3&pid=1.7',
  ...
  totalProductss: number = this.products.length;
  ...
  getvalp(vall: any) {
    this.ja = vall;
    console.log('omkar' + vall);
  }

  slectedFlterRadioBtnChanged: string = 'all';

  onSelectedFilterRadioBtnChange(val: any) {
    this.slectedFlterRadioBtnChanged = val;
  }
  ...
  // empty string
  @Input()
  emptySearchVarstore: any = '';

  tostore: any = '';

  funcall() {
    this.tostore = this.getSearchInlist;
